...
import { createEvent, deleteEvent, getAllEvent, updateEvent, getFilteredEvent, getEventTeams } from '../controllers/event.controller.js'
...
router.get('/getTeams/:id',verifyAdmin, getEventTeams)
