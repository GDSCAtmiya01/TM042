          ...
          <div id="containerc">
              ...
              <div style={{ width: "45%", marginBottom: "10px" }}>
                ...
                <div class="fieldc" style={{ height: "40px" }}>
                  <input
                    ...
                    value={credentials.totalParticipants}
                    required
              ...
              <div style={{ width: "45%", marginBottom: "5px" }}>
                ...
                <div class="fieldc" style={{ height: "45px" }}>
                  <input
                    type="text"
                    name="createdBy"
                    value={credentials.createdBy}
                    required
                    placeholder="Competition is Created by"
                    onChange={onchange}
                  />
                </div>
              </div>
            ...
            <div id="check" style={{ marginBottom: "5px", display: "flex" }}>
              ...
              <input
                type="checkbox"
                name="allowTeams"
                value={credentials.allowTeams}
                class="allowTeam"
                checked="false"
                required
                style={{ width: "5%", height: "15px" }}
                onChange={generateLimitFieldc}
              />
            </div>
            ...
            >
              ...
              <button className="btn" value={"save"} onClick={handleSubmitsave}>
                Save
              </button>
            </div>
          </div>
